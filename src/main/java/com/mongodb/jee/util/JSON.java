...
public class JSON {
    ...
    public static String serialize( Object o ){
        return JSONSerializers.getLegacy().serialize(o);
    }
    ...
    public static void serialize( Object o, Writer writer) throws IOException {
        JSONSerializers.getLegacy().serialize(o, writer);
    }
    ...
    public static void serialize( Object o, OutputStream out) throws IOException {
        JSONSerializers.getLegacy().serialize(o, out);
    }
    ...
    static void string( String s, Writer writer, OutputStream out ) throws IOException{
        ...
        for(int i = 0; i < s.length(); ++i){
            ...
            if (c == '\\')
            	...
            	JSON.append("\\r", writer, out);
            else if(c == '\t')
            	JSON.append("\\t", writer, out);
            else if(c == '\b')
            	JSON.append("\\b", writer, out);
            else if ( c < 32 )
                continue;
            else
            	JSON.append(c, writer, out);
        }
        JSON.append("\"", writer, out);
    }
    
    static void append(String s, Writer writer, OutputStream out)
			throws IOException {
		if (writer != null) {
			writer.write(s);
		} else {
    ...
    static void append(char c, Writer writer, OutputStream out)
			throws IOException {
		if (writer != null) {
			writer.write(c);
		} else {
	...
	static void serialize(ObjectSerializer serializer, Object obj,
			Writer writer, OutputStream out) throws IOException {
		if (writer != null) {

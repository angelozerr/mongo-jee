...
/**
 * On your server, you should look at the header in the request to know which
 * items to return. The server should respond with a Content-Range: header to
 * indicate how many items are being returned and how many total items exist.
 * For example:
 * 

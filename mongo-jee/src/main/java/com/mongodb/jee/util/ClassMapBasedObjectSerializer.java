...
class ClassMapBasedObjectSerializer extends AbstractObjectSerializer {
     ...
     */
    //@Override
    protected void serialize(Object obj, Writer writer, OutputStream out) throws IOException{
            
        obj = Bytes.applyEncodingHooks( obj );
        
        if(obj == null) {
            JSON.append(" null ", writer, out);
            return;
        }
        ...
        JSON.serialize(serializer, obj, writer, out);        
    }
